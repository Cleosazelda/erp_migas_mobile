  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      setState(() {
        ...
        _selectedType = _documentTypes.firstWhere(
              (e) => e.id == _selectedType.id,
          orElse: () => _documentTypes.first,
        );

        _selectedPic = _picOptions.firstWhere(
              (e) => e.id == _selectedPic.id,
          orElse: () => _picOptions.first,
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: MansisDrawer(
        ...
        selectedPage: MansisDrawerPage.documents,
        onNavigateHome: () => Navigator.pop(context),
        onNavigateDocuments: () {},
        onNavigatePic: widget.isAdmin
            ? () async {
          ...
          if (mounted) _loadData();
            ...
            : null,
        onNavigateTypeDocument: widget.isAdmin
            ? () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
